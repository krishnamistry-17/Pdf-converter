    ...
    <div className="max-w-7xl mx-auto px-4 ">
      <div className="text-center mb-12">
        ...
        <p className="md:text-lg text-md text-gray-500 mt-2">
          Fast, secure, and easy file watermarking
        </p>
        <p className="md:text-lg text-md text-gray-500 mt-2">
          Add a watermark to your PDF files easily and quickly. Choose the file type you want
          to watermark and click the watermark button.
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {fileOperations
          .find((operation: any) => operation.title === "WaterMark")
